...
const standards = [
    ...
    },
    {
        ...
        themeOrPractice: 'practice',
        standardNumber: 'W.1',
        text: 'Determine the details of what is explicitly stated and make logical inferences or valid claims that square with textual evidence',
        depthOfKnowledge: '',
        linkedLesson: ['Non-Fiction', 'Drama']
    },
    {
        subject: 'english', 
        subtopic: 'language',
